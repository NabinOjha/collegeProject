 ...
 */
class Style extends linkElement_1.LinkElement {
    constructor(init) {
        super(init);
...
(function (Style) {
    ...
    })(StyleIdentifierEnum = Style.StyleIdentifierEnum || (Style.StyleIdentifierEnum = {}));
    let TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Paragraph"] = 'Paragraph'] = "Paragraph";
        TypeEnum[TypeEnum["Character"] = 'Character'] = "Character";
        TypeEnum[TypeEnum["Table"] = 'Table'] = "Table";
        TypeEnum[TypeEnum["List"] = 'List'] = "List";
    })(TypeEnum = Style.TypeEnum || (Style.TypeEnum = {}));
